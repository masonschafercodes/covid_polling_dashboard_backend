...
var pres_url = 'https://projects.fivethirtyeight.com/2020-general-data/presidential_poll_averages_2020.csv';
...
fs.createReadStream(pres_url)
    ...
    .on('data', (row) => {
        MongoClient.connect(url, function(err, db) {
            ...
            var myobj = { state: row.state, date: row.modeldate, candidate: row.candidate_name,pct: pct_trend_adjusted};
